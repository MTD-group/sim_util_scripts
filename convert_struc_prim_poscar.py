...
Output basename matches the input with a ``.vasp`` suffix. If that file already exists,
writes ``*_prim.vasp`` instead.

Usage:
    convert_struc_prim_poscar.py [--symprec SYMPREC] [--angle-tol DEG] FILE [FILE ...]
"""
